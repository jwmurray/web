...
class CustomFieldsControllerTest < ActionController::TestCase
  ...
  test "should create custom_field" do
    assert_difference('CustomField.count') do
      post :create, custom_field: { displayed: @custom_field.displayed, field_type: @custom_field.field_type, name: @custom_field.name, parent_type: @custom_field.parent_type }
    end
  ...
  test "should update custom_field" do
    patch :update, id: @custom_field, custom_field: { displayed: @custom_field.displayed, field_type: @custom_field.field_type, name: @custom_field.name, parent_type: @custom_field.parent_type }
    assert_redirected_to custom_field_path(assigns(:custom_field))
  end
